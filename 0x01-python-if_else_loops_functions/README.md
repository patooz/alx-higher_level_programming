0-positive_or_negative.py - A python program that print whether the number stored in the variable number is positive or negative.
...
102-magic_calculation.py - the Python function def magic_calculation(a, b, c):
